...
import { Building02Icon, Mail02Icon, PreferenceHorizontalIcon } from "@hugeicons/core-free-icons";
...
const VendorListItem = ({ vendor, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-3">
        ...
        {/* Contact Phone */}
        <div className="flex items-center gap-2 text-sm">
          <HugeiconsIcon icon={PreferenceHorizontalIcon} className="text-muted-foreground flex-shrink-0" />
